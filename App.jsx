...
const NAV = [
  ...
  { id: 'modules', label: 'الوحدات', icon: Boxes },
  { id: 'grades', label: 'النقط', icon: ClipboardCheck },
  { id: 'controle', label: 'المراقبة المستمرة', icon: FileCheck2 },
  { id: 'tp', label: 'الأشغال التطبيقية', icon: Wrench },
  { id: 'efm', label: 'امتحان نهاية الوحدة', icon: Award },
  { id: 'regional', label: 'الامتحان الجهوي', icon: Flag },
  { id: 'attendance', label: 'الحضور', icon: CalendarCheck2 },
  { id: 'professors', label: 'الأساتذة', icon: UserSquare2 },
  { id: 'students', label: 'المتدربون', icon: Users },
...
const GTYPES = [
  { key: 'controle', label: 'المراقبة المستمرة' },
  { key: 'tp', label: 'الأشغال التطبيقية' },
  { key: 'efm', label: 'امتحان نهاية الوحدة' },
  { key: 'regional', label: 'الامتحان الجهوي' },
];
